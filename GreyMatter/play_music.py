...
def mp3gen(music_path):
    """
    This function finds all the MP3 files in a folder an its subfolders and returns a list:
    """
    music_list = []
...
def music_player(file_name):
    """
    This function takes the name od a music file as an argument and plays it depending on the OS
    """
